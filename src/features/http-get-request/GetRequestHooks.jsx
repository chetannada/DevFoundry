  ...
  return (
    <>
      <div className="mt-8 flex flex-col flex-wrap items-center justify-center text-center">
        ...
        <h2 className="flex flex-row justify-center flex-wrap gap-2 h-auto w-164 md:w-128 sm:w-96 xsm:w-72 mob:w-60 xmob:w-56 p-4 text-xl bg-card-light dark:bg-card-dark border border-border-light dark:border-border-dark rounded-2xl shadow-[#1a202c] dark:shadow-[#f7fafc] shadow-md">
