      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2">
        {ART_STYLES.map(style => (
          <button
            ...
            className="p-2 transition-colors text-left group bg-card-light dark:bg-card-dark border border-border-light dark:border-border-dark rounded-md shadow-card-light dark:shadow-card-dark"
          >
